...
import skyTonightScreenshot from './project-moonshot/sky_tonight_screenshot_suspension_bridge_2.png';
import photoPillsScreenshot from './project-moonshot/photopills.png';
